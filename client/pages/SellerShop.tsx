...
export default function SellerShop() {
  ...
  return (
    <div className="container mx-auto px-4 py-10">
      <div className="rounded-3xl bg-gradient-to-br from-primary/40 via-secondary/50 to-accent/40 p-8">
        <div className="max-w-2xl">
          <div className="flex items-center gap-4">
            <img src={seller.avatar} alt={seller.name} className="h-16 w-16 rounded-full" />
            <div>
              <h1 className="text-2xl md:text-3xl font-semibold">{seller.name}</h1>
              <div className="text-sm text-muted-foreground">⭐ {seller.rating} · {seller.location}</div>
            </div>
          </div>
      ...
      <h2 className="mt-10 text-xl md:text-2xl font-semibold">Ratings & Reviews</h2>
      <div className="mt-3 space-y-3">
        {["Beautiful work!","Fast shipping and great quality.","Highly recommend this shop."].map((t,i)=> (
